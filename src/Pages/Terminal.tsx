...
const Terminal: React.FC = () => {
  ...
  return (
    <div
      ...
      className='w-full md:w-3/6  shadow-lg rounded-md text-white absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 overflow-scroll scrollbar-hide cursor-text'
    >
